...
PreparedStatement ps=con.prepareStatement("select * from walex_categories_section order by id desc ");
ResultSet rs=ps.executeQuery();%>	
<%while(rs.next()){%>	

<a class="nav-item nav-link" href="categories.jsp?m=<%=rs.getString("cat")%>"><%=rs.getString("cat")%></a>
<%} %>
</div>
